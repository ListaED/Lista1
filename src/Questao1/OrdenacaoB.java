...
public class OrdenacaoB {

    //<editor-fold desc="Bubble Sort">
    public static void ordemDecrescenteBubbleSort(Funcionario[] fvetor, int n) {
        int i;
        int j;
        Funcionario aux;
        for (i = 0; i < n; i++) {
    ...
    public static void ordemDecrescenteInsertionSort(Funcionario[] fvetor, int n) {
        int i;
        int j;
        Funcionario eleito;
        for (i = 1; i < n; i++) {
    ...
    public static void ordemDecrescenteMergeSort(Funcionario[] fvetor, int n) {
        int inicio = 0;
        int fim = n;
